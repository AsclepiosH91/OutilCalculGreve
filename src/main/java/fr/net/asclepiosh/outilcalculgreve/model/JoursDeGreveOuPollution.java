...
/**
 * Model class for a JoursDeGreveOuPollution.
 *
 * @author Nicolas Torres
 */
public class JoursDeGreveOuPollution {
	 ...
	 * Default constructor.
	 */
	public JoursDeGreveOuPollution() {
		this(null, null);
	}
	 ...
	 * @param transportJour
	 */
	public JoursDeGreveOuPollution(String nomJour, String transportJour) {
